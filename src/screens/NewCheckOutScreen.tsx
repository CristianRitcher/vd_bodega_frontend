...
export const NewCheckOutScreen: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Éxito', `Check-out completado para ${seriales.length} items`, [
        {
          text: 'OK',
      ...
      <View style={styles.content}>
        ...
        >
          <Text style={styles.submitButtonText}>
            {loading ? 'Procesando...' : `Hacer Check-Out (${seriales.length})`}
          </Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
